...
function getHtmlFederation(): string {
    ...
    $html->addHtml("Barcode Buddy Federation enables you to lookup barcodes that other users have already associated with a Grocy product before.
                          The lookup is very fast (around 20ms, depending on your location) and should be quite accurate.
                          ...
                          for commercial purposes. The sourcecode for the server application is available on Github and can be selfhosted as well.</i></span>");
    $html->addLineBreak(3);
